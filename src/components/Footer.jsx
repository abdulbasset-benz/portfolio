...
const Footer = () => {
  return (
    <div className="w-screen overflow-hidden p-10 bg-black text-primary ">
    
      <div className="flex flex-col items-center ">
        <h1 className="font-clash font-bold text-[clamp(1.9rem,8vw,5rem)] uppercase">Abdulbasset-benz</h1>
