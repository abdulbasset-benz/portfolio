  ...
  return (
    <footer className="w-full bg-[#F0EDE6] overflow-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-8 px-6 md:px-12 pt-14 pb-10">
        {/* Quick Links */}
        <div>
          <p className="text-xs font-semibold font-inter uppercase tracking-widest text-black mb-5">
            Quick Links
          </p>
      ...
      <div className="px-6 md:px-10 overflow-hidden">
        <h2 className="font-clash font-bold text-center w-full text-[clamp(1rem,10vw,7.5rem)] leading-none tracking-[-0.04em] text-primary whitespace-nowrap">
          Abdulbasset-Benz
        </h2>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 px-6 md:px-12 pb-8 pt-3">
        ...
        <div className="flex justify-center gap-4">
          <a
            href="#"
            className="text-xs font-inter text-[#999] hover:text-black transition-colors"
          >
            Terms
          </a>
          <a
